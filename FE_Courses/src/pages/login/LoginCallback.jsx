    ...
    if (token) {
      try {
        ...
        if (roles.includes('ROLE_STUDENT') && studentId === 'null') {
          ...
          console.log('[LoginCallback] Show student modal');
          return;
        }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      ...
      <Modal isOpen={showTeacherModal} onClose={handleCloseModal}>
        ...
        <Modal isOpen={showStudentModal} onClose={handleCloseModalStudent}>
            <h2 className="text-lg font-semibold mb-4">Cập nhật hồ sơ Học sinh</h2>
            <p className="text-gray-700 mb-4">Vui lòng cập nhật thông tin hồ sơ học sinh để tiếp tục.</p>
            <div className="flex justify-end">
                <button
